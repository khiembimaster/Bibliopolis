...
export default function ProductList() {
  ...
  const handleSearch = async () => {
    ...
    const priceMin = Number(
      (document.getElementById("priceMin") as HTMLInputElement).value
    );
    ...
    const { books: fetchedBooks, totalPage: fetchedTotalPage } =
      await searchBooksByName(name, 1, priceMin, priceMax, currentPage, 10);
    setBooks(fetchedBooks);
    setTotalPage(fetchedTotalPage);
  };
    ...
    <div className="grid ">
      <div className="grid grid-cols-3">
        <div className="col-start-1">
          <select
            ...
            id="genre"
            className="block w-50 p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <div className="grid grid-cols-4 gap-5 mt-10">
        {books.map((product) => (
          <div
            key={product.id}
            className="border rounded p-4 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg">
